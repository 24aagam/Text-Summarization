...
class ModelEvaluation:
    ...
    def calculate_metric_on_test_ds(self, dataset, metric, model, tokenizer,
        ...
        for article_batches, target_batches in tqdm(zip(article_batches, target_batches), total=len(article_batches)):
            ...
            # replace the token, and add the decode texts with the references to the metric.
    ...
    def evaluation(self):
        ...
        model_pegasus = AutoModelForSeq2SeqLM.from_config(self.config.model_path).to(device)
